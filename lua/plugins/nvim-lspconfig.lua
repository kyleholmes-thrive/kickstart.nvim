...
return {
  ...
  config = function()
    ...
    local servers = {
      ...
      -- rust_analyzer = {},
      pyright = {},
      -- sqlls = {}, -- Disabled to avoid Jinja2 template syntax errors in dbt files
      dbt = {
    ...
    -- Get server names but exclude dbt (not available in Mason)
    ...
    vim.list_extend(ensure_installed, {
      ...
      -- dbt-language-server installed manually via npm
    })
